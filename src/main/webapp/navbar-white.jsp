         ...
         <div class="container" align="right">
			...
			<%if(logged) {%>	
				<i class="bi bi-person-fill"
					style="font-size: 1.2rem; color: rgb(20, 20, 20);"></i> <a
					href="payHistory.jsp" style="color: rgb(20, 20, 20); text-decoration-line: none;"><%=namebean.getName()%> 님</a>
				&nbsp;&nbsp;&nbsp;&nbsp;<a style="color: rgb(200, 200, 200);">|</a>&nbsp;&nbsp;&nbsp;		
	            <i class="bi bi-box-arrow-in-right" style="font-size: 1.2rem; color: rgb(0, 0, 0);"></i>        
	    ...
	    <div class="container" align="right" >
	        ...
	        <div class="collapse navbar-collapse" id="navbarResponsive">
	            <ul class="navbar-nav text-uppercase ms-1">
	                ...
	                <li class="nav-item"><a class="nav-link" href="event_main.jsp" style="color: rgb(30,30,30); font-size: 1.05em; font-family: 배달의민족 도현; padding-left: 25px">이벤트</a></li>
	                <li class="nav-item"><a class="nav-link" href="board_List.jsp" style="color: rgb(30,30,30); font-size: 1.05em; font-family: 배달의민족 도현; padding-left: 25px">문의사항</a></li>
                 </ul>
             </div>
         </div>
     </nav>
